...
extends WorldGenAbstractTree {
    ...
    private final IBlockState metaWood = Blocks.field_150364_r.func_176223_P().func_177226_a((IProperty)BlockOldLog.field_176301_b, (Comparable)BlockPlanks.EnumType.OAK);
    private final IBlockState metaLeaves = MillBlocks.LEAVES_PISTACHIO.func_176223_P().func_177226_a((IProperty)BlockLeaves.field_176236_b, (Comparable)Boolean.valueOf(false));
    ...
    public boolean func_180709_b(World worldIn, Random rand, BlockPos position) {
        ...
        if (position.func_177956_o() >= 1 && position.func_177956_o() + treeHeight + 1 <= worldIn.func_72800_K()) {
            ...
            if (state.func_177230_c().canSustainPlant(state, (IBlockAccess)worldIn, position.func_177977_b(), EnumFacing.UP, (IPlantable)((BlockSapling)Blocks.field_150345_g)) && position.func_177956_o() < worldIn.func_72800_K() - treeHeight - 1) {
                ...
                for (int yPos = position.func_177956_o() + 3; yPos <= position.func_177956_o() + treeHeight; ++yPos) {
                    int leavesRadius = 4;
                    if (yPos < position.func_177956_o() + 5) {
                        leavesRadius -= position.func_177956_o() + 5 - yPos;
                    } else if (yPos > position.func_177956_o() + treeHeight - 3) {
                        leavesRadius -= yPos - (position.func_177956_o() + treeHeight - 3);
                    }
                ...
                for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL.func_179516_a()) {
                    if (MillCommonUtilities.randomInt(100) >= 70) continue;
