...
extends WorldGenAbstractTree {
    ...
    private static final IBlockState WOOD_BS = Blocks.field_150363_s.func_176223_P().func_177226_a((IProperty)BlockNewLog.field_176300_b, (Comparable)BlockPlanks.EnumType.ACACIA);
    private static final IBlockState LEAVES_BS = MillBlocks.LEAVES_OLIVETREE.func_176223_P().func_177226_a((IProperty)BlockLeaves.field_176236_b, (Comparable)Boolean.valueOf(false));
