...
implements IMetaBlockName {
    ...
    public BlockSilkWorm(String blockName) {
        ...
        this.func_180632_j(this.field_176227_L.func_177621_b().func_177226_a(PROGRESS, (Comparable)((Object)EnumType.SILKWORMEMPTY)));
    }
    ...
    public void func_180650_b(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        ...
        if (currentValue < 3 && worldIn.func_175699_k(pos.func_177984_a()) < 7 && rand.nextInt(2) == 0) {
    ...
    implements IStringSerializable {
        public static final /* enum */ EnumType SILKWORMEMPTY;
        public static final /* enum */ EnumType SILKWORMIP1;
        public static final /* enum */ EnumType SILKWORMIP2;
        public static final /* enum */ EnumType SILKWORMFULL;
        ...
        static {
            EnumType[] var0;
            SILKWORMEMPTY = new EnumType(0, "silkwormempty");
            SILKWORMIP1 = new EnumType(1, "silkwormip1");
            SILKWORMIP2 = new EnumType(2, "silkwormip2");
            SILKWORMFULL = new EnumType(3, "silkwormfull");
            $VALUES = new EnumType[]{SILKWORMEMPTY, SILKWORMIP1, SILKWORMIP2, SILKWORMFULL};
