...
public class BlockDecorativeStone
extends BlockSlab
implements IMetaBlockName {
    ...
    public BlockDecorativeStone(String blockName) {
        ...
        this.func_180632_j(this.field_176227_L.func_177621_b().func_177226_a(VARIANT, (Comparable)((Object)EnumType.MUDBRICK)));
    }
    ...
    public void func_149666_a(CreativeTabs itemIn, NonNullList<ItemStack> items) {
        for (EnumType enumtype : EnumType.values()) {
            if (enumtype == EnumType.COOKEDBRICK) continue;
    ...
    implements IStringSerializable {
        public static final /* enum */ EnumType MUDBRICK;
        public static final /* enum */ EnumType COOKEDBRICK;
        public static final /* enum */ EnumType MAYANGOLDBLOCK;
        public static final /* enum */ EnumType BYZANTINEMOSAICRED;
        public static final /* enum */ EnumType BYZANTINEMOSAICBLUE;
        public static final /* enum */ EnumType LIGHTBLUEBRICK_BLOCK;
        public static final /* enum */ EnumType LIGHTBLUECHISELED_BLOCK;
        ...
        static {
            EnumType[] var0;
            MUDBRICK = new EnumType(0, "mudbrick", MapColor.field_151650_B, true);
            COOKEDBRICK = new EnumType(1, "cookedbrick", MapColor.field_193561_M, true);
            MAYANGOLDBLOCK = new EnumType(2, "mayangoldblock", MapColor.field_151647_F, false);
            BYZANTINEMOSAICRED = new EnumType(3, "byzantine_mosaic_red", MapColor.field_151645_D, false);
            BYZANTINEMOSAICBLUE = new EnumType(4, "byzantine_mosaic_blue", MapColor.field_151649_A, false);
            LIGHTBLUEBRICK_BLOCK = new EnumType(5, "lightbluebrick_block", MapColor.field_151649_A, false);
            LIGHTBLUECHISELED_BLOCK = new EnumType(6, "lightbluechiseled_block", MapColor.field_151649_A, false);
            $VALUES = new EnumType[]{MUDBRICK, COOKEDBRICK, MAYANGOLDBLOCK, BYZANTINEMOSAICRED, BYZANTINEMOSAICBLUE, LIGHTBLUEBRICK_BLOCK, LIGHTBLUECHISELED_BLOCK};
